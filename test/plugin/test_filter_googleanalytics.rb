require 'helper'
require 'fluent/plugin/filter_googleanalytics'

class GoogleAnalyticsFilterTest < Test::Unit::TestCase
  include Fluent
  ...
  def create_driver(conf = '')
    Test::FilterTestDriver.new(GoogleAnalyticsFilter).configure(conf, true)
  end
